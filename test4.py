...
class Paint(object):
    ...
    def __init__(self):
        ...
        self.classify_button = Button(
            self.root, text='Verify', command=lambda: self.classify(self.c))
    ...
    #     img = self.image1.resize(
    #         (28, 28), ImageGrab.Image.ANTIALIAS).convert('L')
    #     # img.save('缩小.png')
    ...
    #     img2 = Image.fromarray((img * 255).astype(np.uint8))
    #     img2.save('2.jpg')
